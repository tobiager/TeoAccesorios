    ...
    public class DashboardForm : Form
    {
        ...
        public DashboardForm()
        {
            ...
            var lblUser = new Label{
                ...
                ForeColor = Color.White, Dock = DockStyle.Left, AutoSize = true, Font = new Font("Segoe UI", 10, FontStyle.Bold)
            };
        ...
        private void ShowKpis()
        {
            ...
            var kpi = new KPIsView(); // custom panel with the previous dashboard KPIs
